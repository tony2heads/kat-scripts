...
#tenmin=sp[0:300]
start=float(hr)
twosec=sp.shape[0] # number of 2 second dumps, usually 1800 for full hour of observation
end=start+twosec/1800.

#pl.imshow(tenmin,aspect='auto',cmap='rainbow',vmin=-125,vmax=-120,extent=(855,1710,15.1666,15))
pl.imshow(sp,aspect='auto',cmap='rainbow',vmin=-125,vmax=-120,extent=(855,1710,end,start))
